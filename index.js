let blackjackGame = {
  ...
  function blackjackDeal() {
    ...
    if (blackjackGame.turnsOver === true) {
      ...
      let yourImages = document.querySelector("#Player-Box").querySelectorAll("div");
      let dealerImages = document.querySelector("#Dealer-box").querySelectorAll("div");
